...
class Blog extends Component {
    ...
    getBlogItems() {
        ...
        axios.get(`https://koyherrick.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {
            withCredentials: true
        }).then(response => {
            console.log("get more posts", response.data)
            this.setState({
            ...
            console.log("getting the error blog", error);
        });
    }
